...
test.describe('Repository API @P0 @api', () => {
  ...
  test('[P0] POST /api/repositories - should reject unauthenticated requests', async ({
    request,
  }) => {
  ...
  test('[P1] POST /api/repositories - should initiate repository parsing with valid data', async ({
    request,
  }) => {
  ...
  test('[P1] GET /api/repositories/:id - should return 404 for non-existent repository', async ({
    request,
  }) => {
  ...
  test('[P2] POST /api/repositories/:id/refresh - should require authentication', async ({
    request,
  }) => {
    // GIVEN: Repository ID without auth
    const repoId = 'test-repo-123'
