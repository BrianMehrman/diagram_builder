...
test.describe('Viewpoints API @P1 @api', () => {
  ...
  test('[P1] POST /api/viewpoints - should reject unauthenticated requests', async ({
    request,
  }) => {
  ...
  test('[P1] GET /api/viewpoints/:id - should return 404 for non-existent viewpoint', async ({
    request,
  }) => {
  ...
  test('[P2] POST /api/viewpoints/:id/share - should require authentication', async ({
    request,
  }) => {
    // GIVEN: Viewpoint ID without auth
    const viewpointId = 'test-viewpoint-123'
  ...
  test('[P2] GET /api/viewpoints/share/:token - should allow public access with valid token', async ({
    request,
  }) => {
  ...
  test('[P2] GET /api/repositories/:repositoryId/viewpoints - should require authentication', async ({
    request,
  }) => {
