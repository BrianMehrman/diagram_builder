 ...
 */
function generateFlowchart(graph: IVMGraph, options: Required<MermaidExportOptions>): string[] {
  const lines: string[] = []
 ...
 */
function generateClassDiagram(graph: IVMGraph, _options: Required<MermaidExportOptions>): string[] {
  const lines: string[] = []
 ...
 */
function generateC4Diagram(graph: IVMGraph, options: Required<MermaidExportOptions>): string[] {
  const lines: string[] = []
  ...
  validateOptions(options?: MermaidExportOptions): string[] {
    ...
    if (options) {
      ...
      if (options.diagramType !== undefined) {
        const validTypes: MermaidDiagramType[] = [
          'flowchart',
          'classDiagram',
          'c4Context',
          'c4Container',
