...
import { GLTFExporter, createGLTFExporter, exportToGLTF, DEFAULT_GLTF_OPTIONS } from '../gltf.js'
...
describe('GLTFExporter', () => {
  ...
  describe('export()', () => {
      ...
      const graph = createTestGraph([
        {
          ...
          metadata: { label: 'File 1' },
        },
        {
          id: 'class1',
          type: 'class',
          position: { x: 2, y: 0, z: 0 },
          metadata: { label: 'MyClass' },
        },
      ])
      const result = exporter.export(graph)
        ...
        [
          {
            ...
            type: 'class',
            position: { x: 0, y: 0, z: 0 },
            metadata: { label: 'Class1' },
          },
          {
            id: 'class2',
            type: 'class',
            position: { x: 3, y: 0, z: 0 },
            metadata: { label: 'Class2' },
          },
        ],
    ...
    it('should create materials with PBR properties', () => {
      const graph = createTestGraph([{ id: 'node1', type: 'file', metadata: { label: 'Node' } }])
      const result = exporter.export(graph, {
        metallicFactor: 0.5,
        roughnessFactor: 0.3,
      })
