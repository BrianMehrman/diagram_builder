 ...
 */
export function validateNodeMetadata(metadata: unknown, path: string): ValidationResult {
  const errors: ValidationError[] = []
  const warnings: ValidationError[] = []
 ...
 */
export function validateEdge(edge: unknown, path: string, nodeIds: Set<string>): ValidationResult {
  const errors: ValidationError[] = []
  const warnings: ValidationError[] = []
 ...
 */
export function validateGraphMetadata(metadata: unknown, path: string): ValidationResult {
  const errors: ValidationError[] = []
  const warnings: ValidationError[] = []
