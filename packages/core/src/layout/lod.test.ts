...
describe('LOD System', () => {
    ...
    return buildGraph({
      nodes: [
        ...
        { id: 'pkg', type: 'package', parentId: 'repo', metadata: { label: 'pkg', path: '/pkg' } },
        {
          ...
          type: 'directory',
          parentId: 'pkg',
          metadata: { label: 'src', path: '/pkg/src' },
        },
        {
          id: 'file1',
          type: 'file',
          parentId: 'dir',
          metadata: { label: 'a.ts', path: '/pkg/src/a.ts' },
        },
        {
          id: 'file2',
          type: 'file',
          parentId: 'dir',
          metadata: { label: 'b.ts', path: '/pkg/src/b.ts' },
        },
        {
          id: 'class1',
          type: 'class',
          parentId: 'file1',
          metadata: { label: 'ClassA', path: '/pkg/src/a.ts#ClassA' },
        },
        {
          id: 'method1',
          type: 'method',
          parentId: 'class1',
          metadata: { label: 'foo', path: '/pkg/src/a.ts#ClassA.foo' },
        },
      ],
      edges: [
  ...
  describe('buildAncestorMap', () => {
    it('should build correct ancestor chains', () => {
      ...
      expect(getAncestors('method1', ancestorMap)).toEqual([
        'class1',
        'file1',
        'dir',
        'pkg',
