...
viewpointsRouter.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    if (!viewpoint) {
      throw new NotFoundError('Viewpoint not found', `Viewpoint with ID ${id} does not exist`)
    }
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
      ...
      if (error instanceof Error && error.message.includes('Unauthorized')) {
        throw new ForbiddenError('Access denied', 'You can only update your own viewpoints')
      }
      throw error
    }
  })
...
viewpointsRouter.delete(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
      ...
      if (error instanceof Error && error.message.includes('Unauthorized')) {
        throw new ForbiddenError('Access denied', 'You can only delete your own viewpoints')
      }
      throw error
    }
  })
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        if (error.message.includes('Unauthorized')) {
          throw new ForbiddenError('Access denied', 'You can only share your own viewpoints')
        }
      }
      throw error
    }
