...
describe('WorkspaceConfig', () => {
  ...
  it('creates workspace via API on submit', async () => {
    ...
    await waitFor(() => {
      expect(mockCreate).toHaveBeenCalledWith(expect.objectContaining({ name: 'My Workspace' }))
    })
  })
  ...
  it('trims whitespace from name', async () => {
    ...
    await waitFor(() => {
      expect(mockCreate).toHaveBeenCalledWith(expect.objectContaining({ name: 'Test Workspace' }))
    })
  })
