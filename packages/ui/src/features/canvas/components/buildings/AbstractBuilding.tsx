...
import { getDirectoryFromLabel, getDirectoryColor, BASE_CLASS_EMISSIVE } from '../../views/colorUtils';
...
export function AbstractBuilding({ node, position, methods, lodLevel, encodingOptions, isBaseClass, graph }: ClassBuildingProps) {
  ...
  const roomPlacements = useMemo(() => {
    ...
    // Cone interior uses base width for both dimensions
