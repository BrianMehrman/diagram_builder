...
export const sampleGraph: IVMGraph = {
  nodes: [
    ...
    // Class nodes
    {
      ...
      metadata: {
        label: 'Application',
        path: 'src/app.ts#Application',
        properties: { methodCount: 5, propertyCount: 3 },
      },
    ...
    },
    {
      ...
      metadata: {
        label: 'Logger',
        path: 'src/utils.ts#Logger',
        properties: { methodCount: 3, propertyCount: 1 },
      },
    ...
    // Function nodes
    {
      ...
      metadata: {
        label: 'initialize',
        path: 'src/app.ts#initialize',
        properties: { paramCount: 2 },
      },
    ...
    },
    {
      ...
      metadata: {
        label: 'parseConfig',
        path: 'src/app.ts#parseConfig',
        properties: { paramCount: 1 },
      },
      position: { x: 2, y: 1.5, z: 2 },
      lod: SemanticTier.Symbol,
    },
