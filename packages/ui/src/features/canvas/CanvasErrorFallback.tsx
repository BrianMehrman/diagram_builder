 ...
 */
export function CanvasErrorFallback({ error, resetError }: CanvasErrorFallbackProps) {
  return <FeatureErrorFallback error={error} featureName="Canvas" resetError={resetError} />
}
