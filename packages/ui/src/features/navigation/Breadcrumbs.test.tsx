...
describe('Breadcrumbs', () => {
  ...
  it('renders null when no node is selected', () => {
    const { container } = render(
      <Breadcrumbs selectedNode={null} nodes={mockNodes} onNodeClick={vi.fn()} />
    )
  ...
  it('renders home icon', () => {
    ...
    render(<Breadcrumbs selectedNode={file} nodes={mockNodes} onNodeClick={vi.fn()} />)
  ...
  it('shows file > class path for class node', () => {
    ...
    render(<Breadcrumbs selectedNode={classNode} nodes={mockNodes} onNodeClick={vi.fn()} />)
  ...
  it('shows file > class > method path for method node', () => {
    ...
    render(<Breadcrumbs selectedNode={method} nodes={mockNodes} onNodeClick={vi.fn()} />)
  ...
  it('shows separators between breadcrumb items', () => {
    const method = mockNodes[2]
    const { container } = render(
      <Breadcrumbs selectedNode={method} nodes={mockNodes} onNodeClick={vi.fn()} />
    )
  ...
  it('calls onNodeClick when breadcrumb is clicked', async () => {
    ...
    render(<Breadcrumbs selectedNode={method} nodes={mockNodes} onNodeClick={onNodeClick} />)
