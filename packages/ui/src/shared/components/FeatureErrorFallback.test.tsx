...
describe('FeatureErrorFallback', () => {
  it('renders feature name and error message', () => {
    ...
    render(<FeatureErrorFallback error={error} featureName="Canvas" resetError={resetError} />)
  ...
  it('calls resetError when try again button is clicked', () => {
    ...
    render(<FeatureErrorFallback error={error} featureName="MiniMap" resetError={resetError} />)
  ...
  it('displays descriptive message about feature error', () => {
    ...
    render(<FeatureErrorFallback error={error} featureName="Export" resetError={resetError} />)

    expect(
      screen.getByText('This feature encountered an error and could not be displayed.')
    ).toBeDefined()
  })
})
