 ...
 */
function matchesKeyCombination(event: KeyboardEvent, combination: KeyCombination): boolean {
  return (
 ...
 */
export function useKeyPress(targetKey: string | KeyCombination): boolean {
